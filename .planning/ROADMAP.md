...
- [x] 05-03-PLAN.md — PDF renderer: pdf_renderer.py (fpdf2, DejaVu font, render_pdf → bytes)
...
- [x] 06-02-PLAN.md — Dashboard scaffold: Vite+React project, Dockerfile, nginx.conf, docker-compose.yml fixes
